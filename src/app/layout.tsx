...
export const metadata: Metadata = {
  title: "MasturCoders | Ukrainian Software Development Company",
  description: "Custom web and mobile app development services by expert Ukrainian developers. Full-stack solutions for startups and enterprises.",
  keywords: "software development, web development, mobile apps, Ukraine, custom development, tech solutions",
  metadataBase: new URL("https://masturcoders.com"),
  alternates: {
    canonical: "https://masturcoders.com"
  },
  openGraph: {
    title: "MasturCoders - Software Development Experts",
    description: "Building innovative digital solutions for businesses across Ukraine and beyond",
    siteName: "MasturCoders",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764869545751-9ywgmlzj.jpg",
        alt: "MasturCoders development team"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "MasturCoders - Ukrainian Software Development",
    description: "Expert web and mobile development solutions",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764869545751-9ywgmlzj.jpg"]
  },
  robots: {
    index: true,
    follow: true
